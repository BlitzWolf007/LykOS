...
static bool vnode_get_page(vm_object_t *obj, size_t offset,
...
static bool vnode_put_page([[maybe_unused]] vm_object_t *obj,
                          [[maybe_unused]] page_t *page)
{
    return true;
}

static void vnode_destroy(vm_object_t *obj)
{
    void *ptr;
    size_t index = 0;
